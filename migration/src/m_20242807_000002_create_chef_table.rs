...
use super::m_20242807_000001_create_bakery_table::Bakery;

pub struct Migration;

impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m_20242807_000002_create_chef_table" // Make sure this matches with the file name
    }
}
...
impl MigrationTrait for Migration {
    ...
    // Define how to roll back this migration: Drop the Chef table.
